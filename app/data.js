...
const data = {
  menus: [
    { text: 'Merchants', icon: <Assessment/>, link: '/merchant' },
    { text: 'Categories', icon: <Web/>, link: '/category' },
    { text: 'ListingProducts', icon: <GridOn/>, link: '/listingProduct' },
    { text: 'Orders', icon: <PermIdentity/>, link: '/order' }
  ],
  tablePage: {
    items: [
